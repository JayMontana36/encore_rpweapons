if Config.Updates.CheckForUpdates then
    PerformHttpRequest('https://api.github.com/repos/encorerp/encore_rpweapons/releases/latest', function(errorCode, resultData, resultHeaders)
        Citizen.Wait(1500)
